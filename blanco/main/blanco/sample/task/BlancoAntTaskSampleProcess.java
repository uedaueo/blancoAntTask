...
/**
 * 処理 [BlancoAntTaskSampleProcess]インタフェース。
 *
 * このインタフェースを継承して [blanco.sample.task]パッケージに[BlancoAntTaskSampleProcess]クラスを作成して実際のバッチ処理を実装してください。<br>
 */
interface BlancoAntTaskSampleProcess {
    /**
     ...
     */
    int execute(final BlancoAntTaskSampleProcessInput input) throws IOException, IllegalArgumentException;
